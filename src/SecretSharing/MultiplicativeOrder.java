...
public class MultiplicativeOrder {
    ...
    public static BigInteger moTest(BigInteger a, BigInteger n) {
    ...
    public static void main(String[] args) {
       // moTest(BigInteger.valueOf(37), BigInteger.valueOf(3343));
		...
		/*
		 * BigInteger b = TEN.pow(100).add(ONE); moTest(b, BigInteger.valueOf(7919));
		 * 
		 * b = TEN.pow(1000).add(ONE); moTest(b, BigInteger.valueOf(15485863));
		 * 
		 * b = TEN.pow(10000).subtract(ONE); moTest(b,
		 * BigInteger.valueOf(22801763489L));
		 */
 
        moTest(BigInteger.valueOf(22), BigInteger.valueOf(97));
      //  moTest(BigInteger.valueOf(10L), BigInteger.valueOf(11L));
    }
}
